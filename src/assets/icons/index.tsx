...
export const Plus = ({ fill = "#757575", width = 24 }: IconProps) => (
  <Icon
    fill={fill}
    width={width}
...
export const CheckedBox = ({ fill = "rgba(0, 0, 0, 0.54)" }: IconProps) => (
  <Icon
    height={16}
    width={20}
    fill={fill}
...
export const UncheckedBox = ({ fill = "rgba(0, 0, 0, 0.54)" }: IconProps) => (
  <Icon
    fill={fill}
...
export const NoResults = ({ height, width, fill = "#FF0C3E" }: IconProps) => (
  <Icon
    height={height}
    width={width}
    fill={fill}
